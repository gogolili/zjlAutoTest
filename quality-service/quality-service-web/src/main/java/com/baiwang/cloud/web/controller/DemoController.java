...
//
//    @Autowired
//    private DemoService quality-serviceService;
//
//    /**
//     *
...
//        logger.info("quality-service list begin request入参:{}", "none");
//        // 查询结果
//        List<ProductVO> vos = quality-serviceService.getProductList();
//        // 打印日志
//        if (logger.isInfoEnabled())
//        {
//            // 日志标准格式 : 入参:aaa 返回结果:bbb cost:[100]ms 业务标识-success
//            logger.info("quality-service list success request入参:{} 返回结果:{} cost {} ms ",
//                "none",
//                vos,
...
//        long start = System.currentTimeMillis();
//        // 输出服务入口日志，用于服务监控统计,必须输出
//        logger.info("quality-service detail begin request入参:{}", "none");
//        // 查询结果
//        ProductVO vo = quality-serviceService.getProductByCode(itemCode);
//        // 打印日志
//        if (logger.isInfoEnabled())
//        {
//            // 日志标准格式 : 入参:aaa 返回结果:bbb cost:[100]ms 业务标识 success
//            logger.info("quality-service detail success request入参:{} 返回结果:{} cost {} ms",
//                itemCode,
//                vo.toString(),
//                (System.currentTimeMillis() - start));
//        }
