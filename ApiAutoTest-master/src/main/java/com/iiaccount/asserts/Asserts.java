...
public class Asserts {
    ...
    public static void asserts(MysqlxDatatypes.Scalar.String caseMess, MysqlxDatatypes.Scalar.String bodyString, String response, String xmlFileName, Map<MysqlxDatatypes.Scalar.String, String> map) throws SQLException, IOException, ClassNotFoundException {
