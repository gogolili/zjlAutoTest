...
/**
 * 基于apache-poi 3.15的Microsoft Excel工具类
 */
public class WriteExcel {
    private SXSSFWorkbook workbook;
    private final XSSFColor colorBorder = new XSSFColor(new java.awt.Color(192, 192, 192), new DefaultIndexedColorMap());
    private final XSSFColor colorHeaderBackground = new XSSFColor(new java.awt.Color(210, 210, 210), new DefaultIndexedColorMap());
    private final XSSFColor colorEvenCellBackground = new XSSFColor(new java.awt.Color(239, 239, 239), new DefaultIndexedColorMap());
     ...
     * <code>false</code>
     * @param withStyle <code>true</code> if in this row will be applied styles for the cells, otherwise
     * <code>false</code>
     * @return created row
     */
    ...
    /**
     * Adds a hyperlink into a cell. The contents of the cell remains peronachalnoe. Do not forget to fill in the
     * contents of the cell before add a hyperlinks. If a row already has been flushed, this method not work!
     *
     * @param sheet Sheet
    ...
    private XSSFCellStyle getCellStyle(int rownum, Object entry, boolean header) {
        ...
        if (styles.containsKey(name)) {
            ...
            style.setBorderColor(XSSFCellBorder.BorderSide.TOP, colorBorder);
...
//                }
     ...
     * @param withHeader <code>true</code> for create auto filter and freeze pane in first row, otherwise
     * <code>false</code>
     */
